...
const ScheduleCard = ({
  ...
  return (
    ...
    >
      ...
      <Typography fontWeight='MEDIUM' className='mt-1 ml-[17] text-gray-300' numberOfLines={1}>{date}</Typography>
      <Typography fontWeight='MEDIUM' className='mt-1 ml-[17] text-gray-300' numberOfLines={1}>{time}</Typography>
      <Typography fontWeight='BOLD' className='mt-6 text-dark-800' numberOfLines={1}>{spaceName}</Typography>
    </TouchableOpacity>
  );
};
