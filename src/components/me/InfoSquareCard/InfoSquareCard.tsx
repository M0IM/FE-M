...
const InfoSquareCard = ({
  ...
  return (
    ...
    >
      {children}
      <Typography fontWeight='MEDIUM' className='text-xs text-gray-400' numberOfLines={1}>{title}</Typography>
    </TouchableOpacity>
  );
};

const InfoSquareCardVariants = cva('flex flex-col items-center justify-center p-5 bg-white w-[100] h-[100] rounded-3xl', {
  variants: {
    platform: {
