  ...
  return (
    <View className='flex flex-row mt-2 items-center mb-2'>
        ...
        <View className='flex flex-col justify-center ml-2'>
          {writer && <Typography fontWeight='MEDIUM' className='text-dark-800 text-xs'>{writer}</Typography>}
          {updatedAt && <Typography fontWeight='MEDIUM' className='text-gray-300 text-xs'>{updatedAt}</Typography>}
        </View>
