...
import { getMoimPostComments, getMoimPostDetail, getMoimPostList, likeMoimPost, likeMoimPostComment, writeMoimPost, writeMoimPostComment, writeMoimPostRecomment } from "apis/post";
