    ...
    <ScreenContainer>
      <View className='mt-1' />
        <CustomDropdown
          ...
          height={160}
        />
        {category && category?.label === '공지사항' && <TouchableOpacity onPress={open} activeOpacity={0.8} className='flex flex-row border-0.5 border-gray-100 rounded-xl bg-gray-100 p-4'>
        ...
        <InputField touched placeholder='제목을 입력해주세요.' value={data.title} onChangeText={text => setData(prev => ({ ...prev, title: text }))} />
        <TextInput
      ...
      <CustomButton onPress={handleOnSubmit} label='게시하기' textStyle='text-white text-base font-bold' className='mt-3' />
